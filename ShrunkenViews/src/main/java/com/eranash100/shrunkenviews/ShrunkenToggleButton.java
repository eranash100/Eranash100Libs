...
public class ShrunkenToggleButton extends androidx.appcompat.widget.AppCompatToggleButton
{
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenToggleButton);

            setClickedStatePercentage(typedArray.getInteger(
                    R.styleable.ShrunkenToggleButton_tb_clicked_state_percent,
                    DEFAULT_CLICKED_STATE_PERCENTAGE));

            setDurationInMillis(typedArray.getInteger(
                    R.styleable.ShrunkenToggleButton_tb_duration_in_millis,
                    DEFAULT_DURATION_IN_MILLIS));

            setIdleAnimationEnabled(typedArray.getBoolean(
                    R.styleable.ShrunkenToggleButton_tb_idle_animation,
