...
public class ShrunkenToggleButton extends ToggleButton
{
     ...
     */
    public ShrunkenToggleButton(Context context)
    {
        super(context);
        init(null);
    }
     ...
     */
    public ShrunkenToggleButton(Context context, int clickedStatePercentage, int durationInMillis)
    {
        super(context);
     ...
     */
    public ShrunkenToggleButton(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public ShrunkenToggleButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
     ...
     */
    public ShrunkenToggleButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenToggleButton);
            this.clickedStatePercentage = typedArray.getInteger(R.styleable.ShrunkenToggleButton_tb_clicked_state_percent, 90);
            this.clickedStatePercentage /= 100;
            this.durationInMillis = typedArray.getInteger(R.styleable.ShrunkenToggleButton_tb_duration_in_millis, 100);
        }
    }
