...
public class ShrunkenEditText extends EditText
{
     ...
     */
    public ShrunkenEditText(Context context)
    {
        super(context);
        init(null);
    }
     ...
     */
    public ShrunkenEditText(Context context, int clickedStatePercentage, int durationInMillis)
    {
        super(context);
     ...
     */
    public ShrunkenEditText(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public ShrunkenEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
     ...
     */
    public ShrunkenEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenEditText);
            this.clickedStatePercentage = typedArray.getInteger(R.styleable.ShrunkenEditText_et_clicked_state_percent, 90);
            this.clickedStatePercentage /= 100;
            this.durationInMillis = typedArray.getInteger(R.styleable.ShrunkenEditText_et_duration_in_millis, 100);
        }
    }
