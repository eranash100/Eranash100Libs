...
public class ShrunkenEditText extends androidx.appcompat.widget.AppCompatEditText
{
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenEditText);

            setClickedStatePercentage(typedArray.getInteger(
                    R.styleable.ShrunkenEditText_et_clicked_state_percent,
                    DEFAULT_CLICKED_STATE_PERCENTAGE));

            setDurationInMillis(typedArray.getInteger(
                    R.styleable.ShrunkenEditText_et_duration_in_millis,
                    DEFAULT_DURATION_IN_MILLIS));

            setIdleAnimationEnabled(typedArray.getBoolean(
                    R.styleable.ShrunkenEditText_et_idle_animation,
