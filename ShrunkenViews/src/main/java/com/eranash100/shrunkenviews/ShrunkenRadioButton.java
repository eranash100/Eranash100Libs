...
public class ShrunkenRadioButton extends androidx.appcompat.widget.AppCompatRadioButton
{
     ...
     */
    public ShrunkenRadioButton(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public ShrunkenRadioButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
