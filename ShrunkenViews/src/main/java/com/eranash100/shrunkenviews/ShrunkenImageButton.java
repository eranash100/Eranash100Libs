...
public class ShrunkenImageButton extends androidx.appcompat.widget.AppCompatImageButton
{
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenImageButton);

            setClickedStatePercentage(typedArray.getInteger(
                    R.styleable.ShrunkenImageButton_ib_clicked_state_percent,
                    DEFAULT_CLICKED_STATE_PERCENTAGE));

            setDurationInMillis(typedArray.getInteger(
                    R.styleable.ShrunkenImageButton_ib_duration_in_millis,
                    DEFAULT_DURATION_IN_MILLIS));

            setIdleAnimationEnabled(typedArray.getBoolean(
                    R.styleable.ShrunkenImageButton_ib_idle_animation,
