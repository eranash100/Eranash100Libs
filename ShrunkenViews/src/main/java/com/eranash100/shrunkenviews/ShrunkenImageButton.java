...
public class ShrunkenImageButton extends ImageButton
{
     ...
     */
    public ShrunkenImageButton(Context context)
    {
        super(context);
        init(null);
    }
     ...
     */
    public ShrunkenImageButton(Context context, int clickedStatePercentage, int durationInMillis)
    {
        super(context);
     ...
     */
    public ShrunkenImageButton(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public ShrunkenImageButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
     ...
     */
    public ShrunkenImageButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
    ...
    private void init(@Nullable AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ShrunkenImageButton);
            this.clickedStatePercentage = typedArray.getInteger(R.styleable.ShrunkenImageButton_ib_clicked_state_percent, 90);
            this.clickedStatePercentage /= 100;
            this.durationInMillis = typedArray.getInteger(R.styleable.ShrunkenImageButton_ib_duration_in_millis, 100);
        }
    }
